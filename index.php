...
<head>
    ...
    <title>Halaman Login | Sistem Informasi Buku Tamu Bea Cukai Jagoi Babang</title>
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-lg-block bg-primary shadow-lg p-5 text-center">
                                ...
                                <h3 class="text-white">Sistem Informasi Buku Tamu
                                    <br> Bea Cukai Jagoi Babang
                                    <br> <small> Jl. Dwikora No. 2, Jagoi Babang</small>
                                </h3>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="www.instagram.com/fajarshidiq70">by @fajarshidiq70 | 2021 - <?= date('Y') ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
